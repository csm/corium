...
- [How Corium works](theory/index.md)
  - [Datoms and the fact model](theory/datoms.md)
  - [The transaction log](theory/log.md)
  - [Indexes and storage](theory/indexes.md)
  - [Time and database values](theory/time.md)
  - [Processes and roles](theory/processes.md)
...
- [The configuration file](running/config-file.md)
- [The database catalog](running/catalog.md)
- [Schema management](running/schema.md)
- [Index publication](running/indexing.md)

---

# Client surfaces

- [Query console](surfaces/console.md)
- [Terminal dashboard](surfaces/tui.md)
